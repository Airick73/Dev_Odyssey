...
import 'package:dev_odyssey/app_font_family.dart';
...
class AppThemes {
  ...
  static final ThemeData lightTheme = ThemeData(
    textButtonTheme: TextButtonThemeData(
      style: ButtonStyle(
        foregroundColor: MaterialStateProperty.all(_lightOnPrimaryColor),
        backgroundColor: MaterialStateProperty.all(_lightButtonPrimaryColor),
      ),
    ),
  ...
  static final ThemeData darkTheme = ThemeData(
    textButtonTheme: TextButtonThemeData(
      style: ButtonStyle(
        foregroundColor: MaterialStateProperty.all(_darkOnPrimaryColor),
        backgroundColor: MaterialStateProperty.all(_darkButtonPrimaryColor),
      ),
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ButtonStyle(
